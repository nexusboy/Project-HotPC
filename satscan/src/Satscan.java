...
public class Satscan {
	...
	public static List<Double> MCSimulations(int simulations,int P, double min_lat, double max_lat, double min_long, double max_long) throws InterruptedException, ExecutionException{
